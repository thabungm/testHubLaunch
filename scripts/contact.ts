 ...
 * No Slack call is made when validation fails.
 */
...
/**
 * Build a Slack message payload using Block Kit format.
 * Escapes user input and truncates to Slack limits.
 */
...
/**
 * Submit a contact form to Slack via the SLACK_URL webhook.
 * Validates input before sending. No network call is made on validation failure.
 */
export async function submitContactForm(
  ...
  // Strip surrounding quotes and trailing comma (defensive parsing)
